...
<div className='home'>
    ...
    <div className='server-section-cards-containar'>
      ...
      <Link to="/grammar"className='server-section-cards-containar ' id="icon">
      ...
      <Link to="/islam"className='server-section-cards-containar ' id="islam">
      ...
      <Link to="/Assignment" className='server-section-cards-containar ' id="task">
